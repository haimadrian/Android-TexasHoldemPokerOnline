...
public class PotTest {
    ...
    public void testPot_threePlayersAllIn_firstPlayerEarnsAll() {
        ...
        Assertions.assertEquals(HandRank.TRIPS, playerToEarnings.get(players[0]).getHandRank().getRank().getHandRank(), "Expected hand rank is three of a kind");
    }
    ...
    public void testPot_threePlayersAllIn_splitPotBetweenTwo() {
        ...
        Assertions.assertEquals(HandRank.TRIPS, playerToEarnings.get(players[2]).getHandRank().getRank().getHandRank(), "Expected hand rank is three of a kind");
    }
    ...
    public void testPot_twoPlayersAllInMoreThanThird_splitDeadMoneyBetweenTwoAndPotToWinner() {
        ...
        Assertions.assertEquals(HandRank.TRIPS, playerToEarnings.get(players[4]).getHandRank().getRank().getHandRank(), "Expected hand rank is three of a kind");
    }
}
